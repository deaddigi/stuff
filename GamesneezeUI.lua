...
do 
	LPH_NO_VIRTUALIZE(function()
		...
		--local themes = {}
		local theme = {
			accent = Color3.fromRGB(255, 198, 254),
		...
		do
			...
			function library:Loader(info)
				...
				theme.accent = accent
				--
				local window = {pages = {}, loader = true, isVisible = false, pageammount = pageammount, callback = callback, wminfo = "kittybox.me || UID : 1 || Ping : $PING || Fps : $FPS", currentPage = nil, fading = false, dragging = false, drag = Vector2.new(0,0), currentContent = {frame = nil, dropdown = nil, multibox = nil, colorpicker = nil, keybind = nil, textbox = nil}}
				--
			...
			function library:New(info)
				...
				function window:Watermark(info)
					...
					--
					function window.watermark:Visibility(visible)
						watermark_outline.Visible = visible
						watermark_inline.Visible = visible
						watermark_frame.Visible = visible
						watermark_accent.Visible = visible
						watermark_title.Visible = visible
						window.watermark.visible = visible
					end
					--
